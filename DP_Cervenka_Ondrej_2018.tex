...
\acknowledgements{Děkuji panu  Ing. Martinu Daňhelovi za čas, který mi věnoval a zejména za cenné rady a odborné vedení mé bakalářské práce.}
...
\definecolor {blue} {HTML} {61878B}
\definecolor {red} {HTML} {955252}
\definecolor {green} {HTML} {7A8A5D}
\definecolor {cyan} {HTML} {679787}
\definecolor {magenta} {HTML} {7C5971}
\definecolor {yellow} {HTML} {C49D4E}
