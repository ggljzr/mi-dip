...
Výsledná aplikace komunikuje s~podřízenými systémy pomocí HTTPS protokolu a umožňuje správu garáží přes webové rozhraní. Celý nadřazený systém je možné provozovat na Raspberry Pi.
}
