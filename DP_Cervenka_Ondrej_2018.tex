...
\acknowledgements{Děkuji panu  Ing. Martinu Daňhelovi za čas, který mi věnoval a zejména za cenné rady a odborné vedení mé diplomové práce. Rád bych také poděkoval rodině za podporu při studiu.}
\abstractCS{
...
Výsledná aplikace komunikuje s~podřízenými systémy pomocí protokolu HTTPS a umožňuje správu garáží přes webové rozhraní. 

Aplikace také zasílá SMS upozornění při detekci poteniconálně nebezpečné situace. SMS jsou posílány pomocí GSM modulu.
...
\keywordsCS{bezpečnost, webová aplikace, HTTPS, Raspberry Pi, Python, Flask}
\keywordsEN{security, web application, HTTPS, Raspberry Pi, Python, Flask}
