...
Správu garáží tvoří případy užití popsané na obrázku \ref{fig:use_case_garage}. Operace vytvoření garáže, zapnutí registračního módu a zobrazení seznamu garáží nejsou vázané k~žádné konkrétní garáži, a jsou tedy k~dispozici na hlavní stránce webového rozhraní ihned po přihlášení.

Zbylé možnosti se již vztahují ke konkrétní garáží a zpřístupní se po zvolení garáže ze seznamu na hlavní stránce.
...
% tj uzivatelsky nastaveni neni primo soucasti toho modelu
