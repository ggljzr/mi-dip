...
% mozna naka vosekana ukazka kodu toho hooku

% napsat jak se pouziva gammu, ze sme to zkouseli s modemama huawei e1750 a e3131

% napsat ze ten program gammu samotnej se moc nehodi > je blokujici a potrebuje extra pristupovy prava ktery by musel mit process ve kterym bezi cela webova aplikace, a je teda lepsi pouzit ten demon gammu-smsd

% trochu popsat jak funguje to gammu-smsd
