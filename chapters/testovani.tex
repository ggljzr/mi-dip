...
Stránka simulátoru je přístupná na \texttt{https://adresa-systemu/simulator}, pokud byla aplikace nadřazeného systému spuštěna v~ladícím módu (\texttt{DEBUG = True} v~konfiguračním souboru aplikace).
