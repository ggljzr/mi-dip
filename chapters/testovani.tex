...
\begin{figure}[h!]
    ...
    \caption[Výsledky testu HTTPS konfigurace]{Výsledky testu HTTPS konfigurace.}
    \label{fig:mvc}
\end{figure}
...
% napsat ze domena je registrovana do 30. 6., certifikat plati do 28. 6., pak uz to vobnovovat nebudu, klidne do footnote

% napsat ze ten ssl test je delanej na lets encrypt certifikat, a ze lokalne ani nejde a nemelo by smysl ho delat proti self-signed certu
