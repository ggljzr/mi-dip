...
\begin{itemize}
    ...
    \item Ǔprava uživatelského nastavení (telefonní číslo pro zasílání upozornění).
\end{itemize}
...
Aplikace byla nasazena na virtuálním serveru ze služby Amazon EC2, s~jedním procesorovým jádrem a 1 GiB paměti. Použitý byl operační systém Ubuntu Xenial 16.04.
