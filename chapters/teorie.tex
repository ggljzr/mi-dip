...
% napsat ze muzem jen posilat data, ne je ziskavat -- same origin policy zminit

% napsat strucne ze ochranu proti csrf de udelat pomoci tech tokenu, tady este jednou zminit ze by to nefungovalo bez same origin policy, protoze by utocnikovi nic nebranilo ziskat z ty stranky ten csrf token
