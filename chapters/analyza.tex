...
Posílání SMS z~nadřazeného systému lze provést dvěma způsoby. První možnost je připojit k~počítači, na kterém systém poběží GSM modul se SIM kartou. Také je možné k~posílání SMS využít internetovou službu, jako je například Twilio.
...
\begin{figure}[h!]
    ...
    \caption[GSM modul Huawei E3131]{GSM modul Huawei E3131 s~odkrytým slotem na SIM kartu.}
