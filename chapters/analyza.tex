...
U~pořízených systému by bylo nutné nějakým způsobem distribuovat veřejnou část certifikátu do jednotlivých zařízení. Například u~platformy \textit{Arduino} lze použít \textit{FirmwareUpdater} pro ruční nahrání nových certifikátů \cite{cert_arduino}.
