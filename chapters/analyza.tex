...
Jedním z~možných uplatnění této varianty je monitorování více garážových komplexů. Místo lokálního nadřazeného systému by mohly všechny podřízené systémy z~každého komplexu komunikovat s~jedním globálním systémem, provozovaným na virtuálním serveru a dostupným z~internetu, jak je naznačeno na obrázku \ref{fig:aws}.

Virtuální servery nabízí například Amazon na své platformě EC2.
