...
Jelikož \textit{Xilinux} staví na \textit{Ubuntu} (konkrétně na verzi 12.04 LTS \cite{xilibus}), neměl by být problém nainstalovat software potřebný pro provoz nadřazeného systému (viz sekce \ref{sec:an_plat}). 
...
\begin{tabular}{|c | c | c |} 
 \hline
 & \textbf{\textit{Raspberry Pi 3}} & \textbf{\textit{Zybo Zynq-7000}} \\
 \hline 
 SoC & \textit{Broadcom BCM2837} & \textit{Xilinx Zynq Z-7010} \\ 
 Procesor & \textit{ARM Cortex A53} & \textit{ARM Cortex A9} \\
 & 4 jádra, 1,2 GHz & 2 jádra, 650 MHz \\
 FPGA & -- & Ekvivalent řady \textit{Artix-7} \\
 ...
 \hline
\end{tabular}
\caption[Srovnání platforem \textit{Raspberry Pi 3} a \textit{Zybo Zynq-7000}]{Srovnání platforem \textit{Raspberry Pi 3} a \textit{Zybo Zynq-7000}} \cite{rpi_benchoff} \cite{zybo_man}
