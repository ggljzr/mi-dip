...
\begin{figure}[h!]
    ...
    \caption[Konečná podoba zařízení]{Základní struktura systému. Jednotlivá garážová čidla využívají komunikační API pro odesílání informací. Uživatel systém spravuje pres webové rozhraní.}
\end{figure}
