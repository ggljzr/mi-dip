...
Další problém může představovat přístupnost serveru z~internetu, což významně zvyšuje \textit{attack surface} celého systému, zvlášt oproti alternativě využívající k~propojení systémů pouze Ethernet u~kterého má (na rozdíl od WiFi) provozovatel fyzický přehled o~připojených zařízeních.
