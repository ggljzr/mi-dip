...
co je potreba probrat:

\begin{itemize}
    \item zakladni struktura, chovani systemu ??
    \item protokol, napsat co vod nej chceme
    \item ukladani dat
...
v~podstate teda popsat co se bude resit v~dalsich kapitolach, zacit nakym rozvinutim tech myslenek z~uvodu.
