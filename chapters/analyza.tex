...
\begin{itemize}
    ...
    \item \textbf{Nezávislost} -- Systém by neměl být příliš závislý na externích službách, alespoň v~omezené míře by měl fungovat i bez přístupu k~internetu.
\end{itemize}
