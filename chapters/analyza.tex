...
V~případě této práce by tedy nadřazený systém i podřízené systémy byly klienty \textit{brokeru}. Podřízené systémy by publikovaly naměřená data, která by nadřazený systém odebíral. Tím by vznikla obdoba \textit{client/server} modelu, zmíněného v~sekci \ref{sec:an_struct}. 
