...
Jako identifikátory pravděpodobně budou stačit 32bitové \textit{integery}. Datum je možné v~SQLite ukládat buď jako textový retězec ve formátu \texttt{YYYY-MM-DD HH:MM:SS.SSS}, reálné číslo, či 32bitový \textit{integer} -- \textit{Unix Time} \cite{sqlite_datetypes}. Z~toho vyplívá, že jedno kontrolní hlášení bude mít velikost alespoň $4 * 32 = 128$ bitů.
