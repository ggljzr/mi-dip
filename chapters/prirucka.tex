...
Pro první přihlášení je možné použít implicitní heslo \uv{password}. Poté je uživatel přesměrován na formulář se změnou hesla a vyzván ke změně z~implicitní hodnoty (viz obrázek \ref{fig:password_change}).
